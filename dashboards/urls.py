...
urlpatterns = [
    ...
    path('translator/', views.TranslatorDashboardView.as_view(), name='translator_dashboard'),
    path('corrector/', views.CorrectorDashboardView.as_view(), name='corrector_dashboard'),
    path('statistics/user/<int:user_id>/', views.UserStatisticsView.as_view(), name='user_statistics'),
